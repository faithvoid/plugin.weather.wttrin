...
- Go to Q:/UserData/advancedsettings.xml and add the following entries (replace the city names with the 3 cities you'd like to cycle between)
 ...
 <pre> ```xml <weather> <areacode1>Toronto, ON</areacode1> <areacode2>New York City, NY</areacode2> <areacode3>Tokyo, Japan</areacode3> <plugin>weather.wttrin</plugin> </weather> ``` </pre> 
